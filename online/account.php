...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <li <?php if(@$_GET['q']==4) echo'class="active"'; ?>><a href="account.php?q=4"><span class="glyphicon glyphicon-list" aria-hidden="true"></span>&nbsp;Leasons</a></li>
...
<?php
if(@$_GET['q']== 4){
  require 'leassons.php';
  
}
if(@$_GET['q']==5){
 ?>
 <div style="display:block;" id="view">
 <h2>View PDF File</h2>
<p style="font-size: 18px;font-weight: bold;">Chapter : <?php //echo $res->LessonChapter;?> | Title : <?php //echo $res->LessonTitle;?></p>
<div class="container">
	<embed id="src" src="<?php echo $_SESSION['pdf'];?>" type="application/pdf" width="100%" height="400px" />
</div> 
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/developer.jpg" width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://facebook.com" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Airo Tony</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+25498668652</h4>
		<h4 style="font-family:'typo' ">airotony8@gmail.com</h4>
		<h4 style="font-family:'typo' ">@self motivated developer</h4></div></div>
		</p>
      </div>
