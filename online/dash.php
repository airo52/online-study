      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active"'; ?>">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="dash.php?q=10">ADD quiz pdf</a></li>
...
<div class="form-group">
  ...
  <div class="col-md-12"> 
    <input  type="submit" name="sub" style="margin-left:45%" class="btn btn-primary" value="Submit" class="btn btn-primary"/>
  </div>
</div>
...
<?php include 'upload.php'; ?>
    ...
    <?php 
    $resul = mysqli_query($con,"SELECT title FROM quiz ORDER BY date DESC") or die('Error');
    while($rosy= mysqli_fetch_assoc($resul)){?>
    
      <option><?php echo $rosy['title'] ?></option>
    ...
    <br><br>
     ...
     <button type="submit" name="action" class="btn btn-primary"type="">Update</button></center>
     </form>
<?php }
 ?>
<!--remove quiz-->
